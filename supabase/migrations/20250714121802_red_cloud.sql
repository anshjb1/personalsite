...
CREATE TABLE IF NOT EXISTS projects (
  ...
  category text, -- web, mobile, research, etc.
  display_order integer DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS publications (
  ...
  abstract text,
  keywords text[],
  publication_type text DEFAULT 'journal', -- journal, conference, preprint, book
...
CREATE TABLE IF NOT EXISTS skills (
  ...
  user_id uuid REFERENCES auth.users(id) ON DELETE CASCADE,
  name text NOT NULL,
  category text NOT NULL, -- technical, clinical, business, language, etc.
